...
public class BTreeTest {
	...
	public void testInsert() throws Exception {
		...
		for (int i = 0; i < keys.size(); i++) {
			...
			Assert.assertTrue(checkBTree(tree, insertResults.get(i)));
		}
	}
	...
	private void fillDeleteResult() {
		// tree values after insert keys
		Integer[][][] res = { { { 16 }, { 10 }, { 20 }, { 3, 8 }, { 12, 13 }, { 17, 18 }, { 21, 22 } }, // 6
	...
	public void testDelete() throws Exception {
		...
		for (int i = 0; i < keys.size(); i++) {
			...
			Assert.assertTrue(checkBTree(bTree, deleteResults.get(i)));
		}
	}
