...
public class LeetCode13 {
	...
	@Test
	public void test1() {
		Assert.assertEquals(true, new Solution1().checkInclusion("ab", "eidbaooo"));
		Assert.assertEquals(false, new Solution1().checkInclusion("ab", "eidboaoo"));
		Assert.assertEquals(true, new Solution1().checkInclusion("aab", "eidaabaoo"));
	}
